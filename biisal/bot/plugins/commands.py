...
<b>Welcome to File to Link Bot! 🤖🔗</b>.

<b>Supports Channel too!</b>.

Send me any type of file – be it a video, audio, document, or more – and I'll swiftly convert it into a handy link for you.
This link will allow you to easily play or download your file whenever you need it. Just send the file and let me do the work for you! 📁🎵🎥.

<b>𝘕𝘰𝘵𝘦 :</b>𝘎𝘦𝘯𝘦𝘳𝘢𝘵𝘪𝘯𝘨 𝘓𝘪𝘯𝘬 𝘖𝘧 𝘈𝘥𝘶𝘭𝘵 𝘊𝘰𝘯𝘵𝘦𝘯𝘵 𝘐𝘴 𝘚𝘵𝘳𝘪𝘤𝘵𝘭𝘺 𝘗𝘳𝘰𝘩𝘪𝘣𝘪𝘵𝘦𝘥. 𝘐𝘧 𝘠𝘰𝘶 𝘞𝘪𝘭𝘭 𝘋𝘰 𝘠𝘰𝘶 𝘞𝘪𝘭𝘭 𝘎𝘦𝘵 𝘗𝘦𝘳𝘮𝘢𝘯𝘦𝘯𝘵 𝘉𝘢𝘯.

<blockquote><a href='https://telegram.me/PrimeFileToLinkBot?startchannel&admin=post_messages+edit_messages+delete_messages'>➜ 𝖠𝖽𝖽 𝖳𝗈 𝖢𝗁𝖺𝗇𝗇𝖾𝗅</a></blockquote>"""
...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<b>ꜱᴏᴍᴇᴛʜɪɴɢ  ᴡᴇɴᴛ  ᴡʀᴏɴɢ  <a href='https://t.me/primeSupGroup'>ᴄʟɪᴄᴋ  ʜᴇʀᴇ  ꜰᴏʀ  ꜱᴜᴘᴘᴏʀᴛ</a></b>",
    ...
    reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("♻ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♻", url="https://telegram.me/BetterProfessor")
                    ]
                ]
            )
)
...
async def help_cd(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ ᴄᴏɴᴛᴀᴄᴛ [ᴏᴡɴᴇʀ](https://telegram.me/BetterProfessor).",
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
    chat_id=m.chat.id,
...
Also You Can Use Me In Your Channel..Just Add Me And Make Me Admin And See My Power 🔥</b>""",
    reply_markup=InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("👨‍💻  Uᴘᴅᴀᴛᴇs", url="https://t.me/PrimeBotsUpdates"),
...
async def cb_handler(client, query):
    ...
    if data == "start":
        ...
        await query.message.edit_caption(
            caption=f"<b>ᴍʏ ɴᴀᴍᴇ : <a href='https://telegram.me/PrimeFileToLinkBot'>ʟɪɴᴋ sᴛʀᴇᴀᴍ ʀᴏʙᴏᴛ</a>\nʜᴏsᴛᴇᴅ ᴏɴ : ᴋᴏʏᴇʙ\nᴅᴀᴛᴀʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ\nʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ 𝟹\nᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://telegram.me/BetterProfessor'>Suhail Ebrahim</a></b>",
            reply_markup=InlineKeyboardMarkup(
                [[ 
        ...
        if len(str(user_id)) == 10:
            ...
            try:
                await client.send_message(user_id , f"<b>ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ʙʏ [Suhail](https://telegram.me/BetterProfessor)\nʀᴇᴀsᴏɴ : {reason}</b>")
        ...
        if len(str(user_id)) == 10:
            try:
                unban_text = "<b>ʜᴜʀʀᴀʏ..ʏᴏᴜ ᴀʀᴇ ᴜɴʙᴀɴɴᴇᴅ ʙʏ [Suhail](https://telegram.me/BetterProfessor)</b>"
